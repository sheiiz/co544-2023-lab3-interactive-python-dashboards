...
app.layout = html.Div(
    ...
    ], style={'width': '30%', 'display': 'inline-block', 'padding-left': '80px'}),
    ...
    html.Div([
        html.Label(("Fixed Acidity"), style={'padding-right': '8px'}),
        dcc.Input(id='fixed_acidity', type='number', required=True),    
        html.Label(("Volatile Acidity"), style={'padding-left': '40px', 'padding-right': '8px'}),
        dcc.Input(id='volatile_acidity', type='number', required=True), 
        html.Label(("Citric Acid"), style={'padding-left': '40px', 'padding-right': '8px'}),
        dcc.Input(id='citric_acid', type='number', required=True),
        html.Br(),html.Br(),
        
        html.Label(("Residual Sugar"), style={'padding-right': '8px'}),
        dcc.Input(id='residual_sugar', type='number', required=True),  
        html.Label(("Chlorides"), style={'padding-left': '40px', 'padding-right': '8px'}),
        dcc.Input(id='chlorides', type='number', required=True), 
        html.Label(("Free Sulfur Dioxide"), style={'padding-left': '40px', 'padding-right': '8px'}),
        dcc.Input(id='free_sulfur_dioxide', type='number', required=True),
        html.Br(),html.Br(),
        
        html.Label(("Total Sulfur Dioxide"), style={'padding-right': '8px'}),
        dcc.Input(id='total_sulfur_dioxide', type='number', required=True),
        html.Label(("Density"), style={'padding-left': '40px', 'padding-right': '8px'}),
        dcc.Input(id='density', type='number', required=True),
        html.Label(("pH"), style={'padding-left': '40px', 'padding-right': '8px'}),
        dcc.Input(id='ph', type='number', required=True),
        html.Br(),html.Br(),
        
        html.Label(("Sulphates"), style={'padding-right': '8px'}),
        dcc.Input(id='sulphates', type='number', required=True),
        html.Label(("Alcohol"), style={'padding-left': '40px', 'padding-right': '8px'}),
